...
<%@ page import="com.zendesk.challenge.data.domain.jpa.Ticket" %>
       ...
       <div class="container">
            <div class="starter-template">
                ...
                <%
                 ...
                 %>
                 <form id="ticketForm" action="/ticket">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <select id="ticketField" name="field">
                                        <option value="Select">Select the Ticket Field</option>
                                ...
                                <td>
                                    Ticket Field Value: <input type="text" id="value" name="value"><br>
                                </td>
                            </tr>
                            <tr>
